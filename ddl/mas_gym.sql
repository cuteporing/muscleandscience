...
(2,'Taek Wondo','strength, speed, stamina','Lorem ipsum dolor sit amet, consectetur adipiscing elit. ','[\"Lorem ipsum pheretra interdurum\",\"Suspendise venis\",\"Saunas personicale\",\"Union terminale\"]','1','upload/class/slide1-1023037567-469433701.jpg','upload/class/thumb/thumb_slide1-1023037567-469433701.jpg','taek-wondo',1,'2015-05-12 00:00:00',1,'2015-05-12 00:00:00'),
...
INSERT INTO `mas_comments` VALUES (1,1,'0231321',1400003,'2014-07-30 00:00:00',0,'2015-05-12 00:00:00');
...
INSERT INTO `mas_company_social` VALUES 
...
INSERT INTO `mas_constant` VALUES 
(1,'META', 'description', 'Gym/Fitness Center', '', '', '', '', '', 1,'2015-05-12 00:00:00',1,'2015-05-12 00:00:00'),
(2,'META', 'keywords', 'gym, fitness, health, center, muscle, science', '', '', '', '', '', 1,'2015-05-12 00:00:00',1,'2015-05-12 00:00:00'),
(3,'META', 'author', 'KBVCodes, 2014', '', '', '', '', '', 1,'2015-05-12 00:00:00',1,'2015-05-12 00:00:00'),
(4,'IMG_PATH', 'banner', '/upload/banner/', '', '', '', '', '', 1,'2015-05-12 00:00:00',1,'2015-05-12 00:00:00'),
(5,'IMAGE_CONFIG', 'allowed_type', 'gif|jpg|png', '', '', '', '', '', 1,'2015-05-12 00:00:00',1,'2015-05-12 00:00:00'),
(6,'IMAGE_CONFIG', 'max_size', '350', '', '', '', '', '', 1,'2015-05-12 00:00:00',1,'2015-05-12 00:00:00'),
(7,'IMAGE_CONFIG', 'max_width', '1024', '', '', '', '', '', 1,'2015-05-12 00:00:00',1,'2015-05-12 00:00:00'),
(8,'IMAGE_CONFIG', 'max_height', '768', '', '', '', '', '', 1,'2015-05-12 00:00:00',1,'2015-05-12 00:00:00'),
(9,'NO_IMAGE', 'file_path', 'assets/img/', '', '', '', '', '', 1,'2015-05-12 00:00:00',1,'2015-05-12 00:00:00'),
(10,'NO_IMAGE', 'raw_name', 'noPhoto-icon', '', '', '', '', '', 1,'2015-05-12 00:00:00',1,'2015-05-12 00:00:00'),
(11,'NO_IMAGE', 'file_ext', '.png', '', '', '', '', '', 1,'2015-05-12 00:00:00',1,'2015-05-12 00:00:00');
...
INSERT INTO `mas_gallery` VALUES 
(1,'Muscle and Science',3,'2014-06-10 00:00:00',1,'public','muscle-and-science'),
(2,'Personal Training',3,'2014-06-12 00:00:00',1,'public','personal-training'),
(3,'GYM Members',3,'2014-06-16 00:00:00',1,'public','gym-members');
...
INSERT INTO `mas_gallery_photos` VALUES 
(1,1,NULL,'upload/gallery/gym2-1003888424.jpg','upload/gallery/thumb/thumb_gym2-1003888424.jpg','1970-01-01','2014-07-05 01:18:21','','NOW OPEN!!!<br>Monday - Friday (07:00 PM - 10:00 PM)<br>Sunday (10:00PM - 05:00PM)'),
(2,1,NULL,'upload/gallery/gym-175870889.jpg','upload/gallery/thumb/thumb_gym-175870889.jpg','0000-00-00','2014-07-05 01:23:55','','No description'),
(3,1,NULL,'upload/gallery/gallery_img4-715403363.jpg','upload/gallery/thumb/thumb_gallery_img4-715403363.jpg','0000-00-00','2014-07-13 13:45:29','','No description'),
(4,3,1400004,'upload/profile/gallery_img1-1114092816.jpg','upload/profile/thumb/thumb_gallery_img1-1114092816.jpg','0000-00-00','2014-07-13 13:47:37','','No description'),
(5,2,1400003,'upload/profile/gallery_img3-305138360.jpg','upload/profile/thumb/thumb_gallery_img3-305138360.jpg','0000-00-00','2014-07-13 13:47:53','','No description'),
(6,2,1400003,'upload/profile/gallery_img2-59900239.jpg','upload/profile/thumb/thumb_gallery_img2-59900239.jpg','0000-00-00','2014-07-13 13:48:08','','No description'),
(7,2,1400003,'upload/profile/gallery_img4-1147442447.jpg','upload/profile/thumb/thumb_gallery_img4-1147442447.jpg','0000-00-00','2014-07-13 13:54:41','','No description'),
(8,2,1400003,'upload/profile/gallery_img1-978112387.jpg','upload/profile/thumb/thumb_gallery_img1-978112387.jpg','0000-00-00','2014-07-13 13:56:31','','No description');
...
INSERT INTO `mas_homebox` VALUES 
...
INSERT INTO `mas_members` VALUES 
...
INSERT INTO `mas_members_payment` VALUES 
...
INSERT INTO `mas_message` VALUES 
...
INSERT INTO `mas_message_details` VALUES 
(1,1,'$msg',1),
(3,1,'asda',1),
(4,1,'sdasdas',1),
(5,2,'sdasdas',1),
...
INSERT INTO `mas_package` VALUES 
(1,'Per Session',1,50.00,'session','Gym package per session'),
(2,'monthly fee',30,450.00,'monthly','Monthly FEE');
...
(3,3,1,'dasdas','../upload/blog/blog_img1-18245475.jpg');
...
INSERT INTO `mas_post_tags` VALUES 
(1,1,'Muscle and Science'),
(2,1,'Gym');
/*!40000 ALTER TABLE `mas_post_tags` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mas_posts`
--

DROP TABLE IF EXISTS `mas_posts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mas_posts` (
...
--
-- Dumping data for table `mas_posts`
--

LOCK TABLES `mas_posts` WRITE;
/*!40000 ALTER TABLE `mas_posts` DISABLE KEYS */;
INSERT INTO `mas_posts` VALUES 
(1,'Muscle and Science Fitness Gym','2014-07-30 22:30:44',0,1400001),
(3,'sdadas','2014-07-30 23:07:00',0,1400001);
/*!40000 ALTER TABLE `mas_posts` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `mas_pt` VALUES 
(1,'1 Session',1,350.00,'session','&#8369; 350.00 Per Session'),
(2,'5 Session',5,1000.00,'session','Save up to &#8369; <span class=\'text-cross\'>750.00</span>'),
(3,'10 Session',10,2000.00,'session','Save up to &amp;#8369; <strike>1,500.00</strike>');
...
INSERT INTO `mas_pt_attendance` VALUES 
(1,1,'2014-07-11'),
(2,1,'2014-07-13');
...
INSERT INTO `mas_pt_members` VALUES 
...
INSERT INTO `mas_pt_payment` VALUES 
...
INSERT INTO `mas_setting` VALUES 
...
INSERT INTO `mas_special_package` VALUES 
...
INSERT INTO `mas_tracer` VALUES 
(1,1400001,'2014-07-07 17:20:37','Muscle Science','Created new user account (dylan.mckenzie) and added it to GYM members'),
(2,1400001,'2014-07-07 17:21:01','Muscle Science','Created new user account (steven.sky) and added it to GYM members'),
(3,1400001,'2014-07-07 17:21:23','Muscle Science','Created new user account (reikado.lezaille) and added it to PT members'),
(4,1400001,'2014-07-07 17:21:36','Muscle Science','Created new user account (aeone.rivera) and added it to PT members'),
(5,1400001,'2014-07-07 17:22:02','Muscle Science','Entered (aeone.rivera) payment for pt (&#8369; 1000)'),
(6,1400001,'2014-07-07 19:07:51','Muscle Science','Deleted GYM membership of (dylan.mckenzie)'),
(7,1400001,'2014-07-07 19:08:00','Muscle Science','Deleted GYM membership of (steven.sky)'),
(8,1400001,'2014-07-07 19:08:15','Muscle Science','Deleted Personal Training membership of (aeone.rivera)'),
(9,1400001,'2014-07-07 19:08:26','Muscle Science','Deleted Personal Training membership of (reikado.lezaille)'),
(10,1400001,'2014-07-07 19:08:42','Muscle Science','Deleted (aeone.rivera)'),
(11,1400001,'2014-07-07 19:08:50','Muscle Science','Deleted (1400004)'),
(12,1400001,'2014-07-07 19:08:59','Muscle Science','Deleted (1400002)'),
(13,1400001,'2014-07-07 19:09:08','Muscle Science','Deleted (1400003)'),
(14,1400001,'2014-07-07 19:10:55','Muscle Science','Created new user account (aeone.rivera) and added it to PT members'),
(15,1400001,'2014-07-13 13:43:36','Muscle Science','Edited (aeone.rivera) user account'),
(16,1400001,'2014-07-13 13:47:23','Muscle Science','Created new user account (steven.sky) and added it to GYM members'),
(17,1400001,'2014-07-17 14:31:19','Muscle Science','Entered (steven.sky) payment for member (&#8369; 50)'),
(18,1400001,'2014-07-17 23:16:21','Muscle Science','Updated Gym class (Boxing), (about) field'),
(19,1400001,'2014-07-20 17:47:10','Muscle Science','Added new gym class (Sdasda)'),
(20,1400001,'2014-07-20 17:48:12','Muscle Science','Removed (Sdasda) from Gym class'),
(21,1400001,'2014-07-21 01:22:10','Muscle Science','Entered (steven.sky) payment for member (&#8369; 100)'),
(22,1400001,'2014-07-21 01:27:30','Muscle Science','Activated user acount (steven.sky)'),
(23,1400001,'2014-07-21 17:07:13','Muscle Science','Updated Gym class (Gym Fitnesss), (about) field'),
(24,1400001,'2014-08-31 12:30:08','Muscle Science','Added (steven.sky) to GYM members'),
(25,1400001,'2014-08-31 12:30:31','Muscle Science','Entered (steven.sky) payment for member (&#8369; 5)'),
(26,1400001,'2014-09-06 02:08:16','Muscle Science','Entered (aeone.rivera) payment for pt (&#8369; 50)');
...
INSERT INTO `mas_trainer` VALUES 
...
CREATE TABLE `mas_users` (
  ...
  `img` int(11) NOT NULL,
  PRIMARY KEY (`_id`)
) ENGINE=InnoDB 00005 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `mas_users` VALUES 
(1400001,'admin','c601f9339c645fb770',30,'Science','Muscle',1,'F','1991-05-20','','muscleandscience@gmail.com','','',0),
(1400002,'Guest','c601f9339c645fb770',10,'','Guest',1,'','2014-07-07','','','','',0),
(1400003,'aeone.rivera','c601f9339c645fb770',10,'Rivera','Aeone',1,'F','2009-00-06','','rivera@yahoo.com','','',0),
(1400004,'steven.sky','7807936dd37a6422ea',10,'sky','steven',1,'M','0000-00-00','','','','',0);
...
-- Dump completed on 2015-05-12 12:50:48
