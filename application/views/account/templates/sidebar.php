<div class="col-md-3 left_col">
	<div class="left_col scroll-view">
		...
		<div class="navbar nav_title" style="border: 0;">
			<a href="<?=base_url()?>" class="site_title" target="_blank"><span>Muscle
					and Science</span></a>
		</div>
		...
		<div class="profile">
			<div class="profile_pic">
				<img
					src="<?=base_url().IMG_GALLERY.$this->user_model->get_user_photo()?>"
		...
		<div class="sidebar-footer hidden-small">
			...
			<a data-toggle="tooltip" data-placement="top" href="<?=base_url()?>account/user-logout" title="Logout"> <span
