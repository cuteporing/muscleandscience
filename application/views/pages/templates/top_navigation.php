<div class="top-bar-container">
	<div class="row">
		<nav class="top-bar" data-topbar role="navigation">
			<ul class="title-area">
				<li class="name">
					<h1><a href="<?=base_url()?>"><img data-interchange="[<?=base_url()?>assets/img/logo.png, (default)], [<?=base_url()?>assets/img/logo-small.jpg, (only screen and (max-width: 640px))]" id="logo"></a></h1>
				</li>
