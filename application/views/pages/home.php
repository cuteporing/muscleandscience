	...
	<div class="row homebox-top">
		...
		<ul class="home-box-container clearfix">
			<li id="upcoming" class="home-box white">
				...
				<a href="" class="next icon-small-arrow right-black" ></a>
				</div>
				...
				<ul class="overview items-list upcoming-classes clearfix">
					<li class="icon-clock-black">
					<a href="classes.php?q=gym-fitness" title="Gym Fitness">Gym Fitness</a>
					<div class="value">17.30 - 20.30</div>
					</li>
					<li class="icon-clock-black">
					<a href="classes.php?q=taek-wondo" title="Taek Wondo">Taek Wondo</a>
					<div class="value">21.00 - 22.00</div>
					</li>
					<li class="icon-clock-black">
					<a href="classes.php?q=boxing" title="Boxing">Boxing</a>
					<div class="value">11.30 - 12.30</div>
					</li>
					<li class="icon-clock-black">
					<a href="classes.php?q=cardio-fitness" title="Cardio Fitness">Cardio Fitness</a>
					<div class="value">14.00 - 15.00</div>
					</li>
					<li class="icon-clock-black">
					<a href="classes.php?q=zumba" title="Zumba">Zumba</a>
					<div class="value">17.30 - 20.30</div>
					</li>
				</ul>
				</div>
